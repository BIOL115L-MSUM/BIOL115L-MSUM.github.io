...
The [finch data](finches_data.xlsx) is saved in a Microsoft Excel document on the Class Share drive. Before we can look at it use it in R, you need to copy it to your project folder.
...
In your project folder, double click the file `finches_data.xlsx` to open it.

How many variables (i.e. columns) are there?
