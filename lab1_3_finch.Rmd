...
- [Introduction]
- [Start the Finch Analysis assignment]
- [Look at the data]
- [R scripts]
- [R packages]
- [Read the data]
...
Your instructor will disseminate a link which will give you access to the Org Bio workspace on RStudio Cloud. Open the link in a web browser, sign in to RStudio Cloud, and click to join the workspace.

Once you have joined, you will see two spaces listed under Spaces in the Navigation panel on the left. The first is **Your Workspace**, the second is **Org Bio**. Select Org Bio.

In the list of projects, you will see two projects listed:

- Assignment #1 Finch Analysis
- Assignment #2 Bluestem Analysis

Click the "Start" button to open **Assignment #1 Finch Analysis**. This will create a copy of the project that can be accessed by both you and the instructor. 

Click the name of the project, **Assignment #1 Finch Analysis**, to open the project.

### Look at the data

In the Files tab you will see a file named **finches_data.xlsx**. This is an excel file containing the data you will work with in this assignment. 

Click the file to download it and open it with Microsoft Excel or another program that will open Excel files. If you do not have a program that will open Excel files, skip to the next section.

Once you have the Excel file open, look at it to answer the following questions. Check with your partner to make sure you get the same anser.
...
In *Part 2. R as a calculator*, you ran commands by typing them into the console. One of the benefits of R over programs such as Excel, for example, is the ability to save your commands in the form of written. Enter the **script**! A script is simply a text file containing commands for R to execute.
