...
To run the code, place your cursor on the same line as the code as click Run on the Source pane toolbar, then Run Selected Lines. Or just hold down the command key and press the enter key. This is called a keyboard shortcut, and is written as **Cmd+Enter**.
...
4. Click **Install**
5. If a question appears in the Console window asking if you want to "install from sources the package which needs compilation", then put your cursor in the console, type "n", and press enter.
...
<p class="text-info">Copy these two lines in the gray box (including the comments) and paste them into your script.</p>

Do not copy the text in the white boxes. That is just to show you what will be output in the console when you run the code.
...
Put your cursor on the first line and press Cmd+Enter to run it. The cursor automatically moves to the next line, so you can press Cmd+Enter again to run the next line.
