...
The finch data is saved in a Microsoft Excel document on the Class Share drive. Before we can look at it use it in R, you need to copy it to your project folder.

1. Open the Finder
2. Go to the Handout Folder (e.g. **classshare/BIOL115L-01/Handout Folder**)
3. Copy the file `finches_data.xlsx` using one of these methods:
    - Click the file, Cmd+C to copy, or
    - Click the file, File > Copy, or
    - Right-click the file, select Copy, or
    - Open the file, click Save As...
4. Go to your Data Lab 1 project folder (e.g. **classshare/BIOL115L-01/Projects/starid/Data Lab 1**)
5. Paste the file

The file should now appear in your Data Lab 1 folder in the Finder. It should also appear in the Files tab in RStudio.

### Look at the data

In data science, each column is called a *variable*. How many variables are there? 

The names of the variables are in the first row. What are the names of the variables? Note that the names are not capitalized and use underscores (`_`) instead of spaces. This is important when writing R code.

What does each row in this dataset represent? How many rows are there?

Now that you've had a look at the data, close the Excel file and move to RStudio.
...
<p class="text-info">Copy the code in the box below (including the comments) and paste it into your script.</p>
