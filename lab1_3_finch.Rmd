...
Find the file named **finches_data.xlsx** in the **File** tab and click on it to download and open it with Microsoft Excel. 

<figure class="figure">
  <a href="images/files_tab_finches_data.png" data-lightbox="rstudio-start" data-title="Find and open the finches data file"><img src="images/files_tab_finches_data.png" class="figure-img img-thumbnail"></a>
  <figcaption class="figure-caption">Find and open the finches data file</figcaption>
</figure>


This is an excel file containing the data you will work with in this assignment. 
