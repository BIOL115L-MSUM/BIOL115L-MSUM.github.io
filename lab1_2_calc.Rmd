...
When you first open RStudio, you will see a window with three panels, the left panel will be on a tab named **Console**, the upper right panel will be on a tab named **Environment**, and the bottom right panel will be on a tab named **Files**, like this:

<figure class="figure">
  <a href="images/rstudio_ide_1.png" data-lightbox="rstudio-ide" data-title="RStudio starts with three panels."><img src="images/rstudio_ide_1.png" class="figure-img img-thumbnail"></a>
  <figcaption class="figure-caption">RStudio starts with three panels.</figcaption>
</figure>
...
[insert screenshot of environment panel]
...
### [Part 3. Finch Data Example &rarr;](lab1_3_finch.html)