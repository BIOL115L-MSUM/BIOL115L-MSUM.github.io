...
To create a new project from scratch, simply press the New Project button from the Projects area. This is what the New Project button looks like in RStudio Cloud:


<figure class="figure">
  <a href="https://rstudio.cloud/images/guide/newProject.png" data-lightbox="rstudio-start" data-title="How to create a new project"><img src="https://rstudio.cloud/images/guide/newProject.png" class="figure-img img-thumbnail"></a>
  <figcaption class="figure-caption">How to create a new project</figcaption>
</figure>
