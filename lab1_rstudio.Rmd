...
To start RStudio, click on the Start menu and immediately start typing "RStudio".

In the search results, click on "RStudio".
...
To create a new project use the **New Project...** command (available on the File menu and on the global toolbar):
