...
Copy the file `bluestem_data.xlsx` from your Class Share Handout Folder to your project folder. Check to make sure it appears in your Files tab in RStudio before continuing.
...
2. It's always easier to modify existing code than to create new code from scratch. To make sure you start off with a nice clean copy of the beak length code, go to this page:
    - [Copy code from beak length script  &rarr;](lab1_beak_length_script.html)
...
You will want to be able to come back to this RStudio project and its files later, either to continue working on this assigment, or to refer to it when working on future lab reports and assignments.

Save all of your files and close RStudio.

Your files will all stay on the Class Share drive through the end of the semester.

To open one of your projects again later:

1. Follow directions to [Access the Class Share drive](lab1_1_rstudio.html#access-the-class-share-drive)
2. Navigate to your **Data Lab 1** folder
3. Double-click the file named **Data Lab 1.Rproj** to open the project.
