...
Edit the document by so it uses your figures and text, and delete the example figures and text at the end of the document. 

When done, the document will contain the following:
