...
<blockquote class="text-success">Do plant height or rame length of Big Bluestem (<i>Andropogon gerardii</i>) plants vary between burned and unburned sites.</blockquote>
...
6. A section titled **RESULTS** which includes:
    - A paragraph describing the difference in plant heights between burned and unburned areas, citing the first two figures and giving the results of the plant height *t*-test.
    - A paragraph describing the difference in rame lengths between burned and unburned areas, citing the last two figures and giving the results of the rame length *t*-test.
...
3. Use "find and replace" (the magnifying glass on the Source tab toolbar) to modify the script.
    ...
    - replace `died` with `burned` and replace `survived` with `unburned`
